...
| 역할   | 이름   | 담당                                                                                              |
| ------ | ------ | ------------------------------------------------------------------------------------------------- |
| 팀장   | 정우수 | 제품 상세페이지, 장바구니 페이지, 주문내역 페이지, 나의 시음 히스토리 페이지, 시음 후기 모달 구현 |
| 개발자 | 이슬비 | 나의 입맛 프로필, 나만의 패키지 구성 (modal), 로그인 페이지, 회원정보 수정(MY)                    |
| 개발자 | 원지향 | 개인 취향 테스트 페이지 구현                                                                      |
| 개발자 | 박소연 | 검색 페이지, 후기 페이지                                                                          |
| 개발자 | 이상호 | 메인페이지, 패키지 상세페이지 구현                                                                |
...
- **Husky 8.0.0 & lint-staged 16.1.2** – Git Hooks 자동화

### Mocking / Testing

- **MSW 2.10.4** – API Mocking & 테스트 환경 지원
...
- **ESLint**: 문법 오류 및 코드 규칙 검사
- **Prettier**: ailwind CSS 플러그인 포함 코드 포맷팅으로 일관된 코드 스타일 유지 및 코드 가독성 향상
- **Husky**: 커밋 전 ESLint, Prettier 자동 포맷팅 및 커밋 메시지 규칙 검사, 푸시 전 빌드 실행으로 빌드 오류 방지
